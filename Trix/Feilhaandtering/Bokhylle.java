public class Bokhylle {
    ...
    public void settInn(Bok b) throws DuplikatException, IkkeMerPlassException {
        for (int i = 0; i < boeker.length; i++) {
            ...
            if (boeker[i] != null && b.toString().equals(boeker[i].toString())) {
                throw new DuplikatException(b.toString());  // Tittelene er like
        ...
        throw new IkkeMerPlassException(b.toString());  // Gått gjennom løkke uten at det skjedde noe
    }
